...
from ingestion_plugin.operators.file_ingestion import FileIngestionOperator
...
with DAG(
    ...
    scan_and_copy = FileIngestionOperator(
        ...
        landing_zone_folder_id="your_landing_zone_folder_id",
        raw_storage_root_folder_id="your_raw_storage_root_folder_id",
    )